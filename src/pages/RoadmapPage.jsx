...
function RoadmapPage({ activePlan, initialStepIndex = 0, onRestart, onStepComplete }) {
  const {
    roadmapData,
    currentStep,
    currentStepIndex,
  ...
  }, [completeCurrentStep, currentStepIndex, currentStep, roadmapData, onStepComplete])
              ...
              return (
                <div key={index} className={`p-roadmap-step-item ${status}`}>
                  ...
                  <div className="p-step-details">
                    <div className="p-step-item-name">
                      {status === 'locked' ? 'Locked' : step.name}
                    </div>
                    {status === 'current' && <div className="p-step-item-meta">Current task</div>}
                    {status === 'locked' && <div className="p-step-item-meta">Unlocks after your current task</div>}
                  </div>
                </div>
              )
            })}
